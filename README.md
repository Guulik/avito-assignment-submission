...
> Если у вас не прошёл какой-то тест, скорее всего это был userget_test и вам просто не повезло на генерацию.
> При генерации баннеров используются случайные значения uint32. Попробуйте сгенерировать баннеры ещё раз
